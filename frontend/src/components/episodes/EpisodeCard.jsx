...
export default function EpisodeCard({ episode }) {
  ...
  return (
    <div
      onClick={handleClick}
      className='p-3 md:p-3 group relative cursor-pointer bg-color-bg shadow-lg rounded-md md:rounded-lg'
    >
      <div className='flex items-center space-x-4'>
        <div>
          ...
          />
          <div
            className={`opacity-0 absolute top-4 left-4 flex justify-center items-center group-hover:opacity-100 transition duration-200 ${
