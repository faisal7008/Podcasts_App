      ...
      <div className="relative cursor-pointer">
        <div className="flex items-center space-x-4">
          ...
          <div className="inline-flex gap-3">
            <button onClick={() => dispatch(setHidePlayer(false))} type="button" className="p-2.5 cursor-pointer rounded-full bg-color-card text-color-font hover:bg-color-dark focus:outline-none shadow transition-all duration-200"><PlayIcon size={22} /></button>
            <button onClick={() => dispatch(resetEpisode())} type="button" className="p-2.5 cursor-pointer rounded-full bg-color-card text-color-font hover:bg-color-dark focus:outline-none shadow transition-all duration-200"><StopIcon size={22} /></button>
          </div>
        </div>
      </div>
    </div>
