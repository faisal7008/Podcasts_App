...
export default function DisplayAudio({ audioUrl, setHide }) {
  ...
  return (
    <div onClick={() => dispatch(setHidePlayer(false))} className="fixed bottom-0 lg:right-0 z-40 lg:mb-5 lg:mr-5 p-5 bg-slate-900 shadow-xl w-full lg:w-1/3 rounded-t-2xl lg:rounded-2xl">
