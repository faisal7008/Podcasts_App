          ...
          <ul className='pt-10'>
            ...
            >
              <div className='flex items-center gap-2'>
                <img src={myPodcastsImg} className='h-7 bg-color-bg rounded-md p-0.5 w-7' alt='' />

                <span
                  className={`text-sm ${
                    current === 'podcasts' ? 'font-bold text-color-font' : 'font-semibold'
                  }`}
                >
                  My Podcasts
                </span>
            ...
            >
              <div className='flex items-center gap-2'>
                ...
                <span
                  className={`text-sm ${
                    current === 'favourites' ? 'font-bold text-color-font' : 'font-semibold'
                  }`}
                >
                  Favourites
                </span>
          ...
          <ul>
            ...
            >
              <div className='flex items-center gap-2'>
                ...
                <span
                  className={`text-sm ${
                    current === 'profile' ? 'font-bold text-color-font' : 'font-semibold'
                  }`}
                >
                  My Profile
                </span>
            ...
            >
              <div className='flex items-center gap-2'>
                <svg
                  ...
                  strokeWidth={1.5}
                  stroke='currentColor'
                  className={`w-6 h-6 ${current !== 'settings' ? '' : 'hidden'}`}
                >
                  <path
                    strokeLinecap='round'
                    strokeLinejoin='round'
                ...
                <span
                  className={`text-sm ${
                    current === 'settings' ? 'font-bold text-color-font' : 'font-semibold'
                  }`}
                >
                  Settings
                </span>
            ...
            >
              <div className='flex items-center gap-2'>
                ...
                <span
                  className={`text-sm ${
                    current === 'logout' ? 'font-bold text-color-font' : 'font-semibold'
                  }`}
                >
                  Logout
                </span>
