...
export default function MyPodcasts() {
  ...
  const videoPodcasts = podcasts?.filter((podcast) => podcast.type === "video" && profile?.favoritePodcasts?.includes(podcast._id));
  const audioPodcasts = podcasts?.filter((podcast) => podcast.type === "audio" && profile?.favoritePodcasts?.includes(podcast._id));
