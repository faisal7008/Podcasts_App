        ...
        <div className="md:w-5/12 h-full p-4 flex flex-col items-center gap-4">
          ...
          <div className="self-start">
            ...
            <h2 className="inline-flex w-full justify-between text-xs font-light">
              ...
              <span>
                {" "}
                Last updated on {moment(podcast?.updatedAt).format("ll")}{" "}
              </span>
            </h2>
            <div className="flex justify-between gap-4 my-4">
              <button onClick={() => {dispatch(setEpisode(episodes[0]))}} className="inline-flex gap-2 items-center justify-center px-4 py-2 text-sm font-semibold w-full bg-color-font text-color-card rounded-full focus:outline-none  transition-opacity duration-200 ease-linear cursor-pointer">
                <PlayIcon size={18} />
                Play all
              </button>
              <div onClick={handleSave} className="inline-flex gap-2 items-center justify-center px-4 py-2 text-sm font-semibold w-full bg-color-font text-color-card rounded-full focus:outline-none  transition-opacity duration-200 ease-linear cursor-pointer">
        ...
        <div className="p-4 w-full min-h-full overflow-y-auto space-y-3">
          <div className="flex justify-between items-start">
            <div className="flex gap-2 items-center">
              <h2 className="text-lg text-color-font font-semibold">
                Episodes
              </h2>
