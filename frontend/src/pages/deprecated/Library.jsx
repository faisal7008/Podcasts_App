  ...
  return (
    <div className='p-7 w-full h-full'>
      <div className='flex gap-3 items-center'>
        ...
        <h2 className='sm:text-lg tracking-wider font-medium text-color-font'>
          {podcast?.name || 'title'}
        </h2>
      </div>
        ...
        <div className='md:w-5/12 h-full p-4 flex flex-col items-center gap-4'>
          ...
          <div className='self-start'>
            ...
            <h2 className='text-xs font-light'>
              22 episodes 2.2M views Last updated on May 21, 2023
            </h2>
            <div className='flex justify-between gap-4 my-4'>
              <button className='px-4 py-2 text-sm font-semibold w-full bg-color-font text-color-card rounded-full '>
                Play all
              </button>
              <button className='px-4 py-2 text-sm font-semibold w-full bg-color-font text-color-card rounded-full '>
                Save
            ...
            <div className='w-full text-base '>description</div>
          </div>
        </div>
