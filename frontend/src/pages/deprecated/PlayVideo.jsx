      ...
      <div className='flex flex-col lg:flex-row w-full h-full py-4 gap-4 '>
        <div className='lg:w-4/6 p-6 bg-color-bg rounded-xl'>
          ...
          <div className=' flex justify-between'>
            <h2 className=' text-lg mb-5 text-color-font'>{podcast.title}</h2>
            <h2 className=' text-lg mb-5 text-color-font'>{podcast.desc}</h2>
          </div>
          <div className='flex gap-3'>
            ...
            <div className='flex-1 min-w-0'>
              ...
              <p className='text-sm text-gray-500 truncate dark:text-gray-400'>120M subscribers</p>
            </div>
          </div>
        </div>
        <div className='lg:w-2/6 h-full px-6 pt-6 flex flex-col gap-3 bg-color-card rounded-xl'>
          ...
          <div className='flex flex-col overflow-auto h-full gap-2'>
            {episodes?.map((episode) => (
              <ListCard key={episode._id} episode={episode} />
            ))}
          </div>
        </div>
      </div>
