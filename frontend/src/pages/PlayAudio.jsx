...
export default function PlayAudio() {
  ...
  return (
    <div className="w-full py-8 h-full pl-6 pr-10 scroll-container overflow-auto lg:overflow-hidden">
      <div className='flex gap-3 items-center'>
       ...
       <svg fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className='w-5 h-5' aria-hidden="true">
  <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 19.5L8.25 12l7.5-7.5" />
      ...
      <div className="flex flex-col lg:flex-row w-full h-full py-4 gap-4 ">
        ...
        {podcasts?.filter(pod => pod.type === 'audio').slice(0,3)?.map((podcast) => (
          <ListCard
            key={podcast._id}
            title={podcast.name}
